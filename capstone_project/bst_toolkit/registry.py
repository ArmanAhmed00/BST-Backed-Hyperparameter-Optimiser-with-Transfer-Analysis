...
class HyperparamRegistry:
    ...
    def __init__(self) -> None:
        # Create self._bst = BST() and self._history = []
        self._bst = BST()
        self._history = []
    ...
    def add_trial(self, score: float, params: dict) -> None:
        ...
        Collision handling: if a trial with this exact score already exists in the BST, 
        the existing params are kept (first-inserted wins) and this call is ignored silently. 
        Round scores to 6 decimals before calling this method to minimise accidental collisions from floating-point noise. 
        """
